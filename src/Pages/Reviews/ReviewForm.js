...
const ReviewForm = ({service}) => {
  ...
  return (
    <div>
      <div className="container flex flex-col my-5 max-w-md p-4 shadow-sm rounded-xl lg:p-6 dark:bg-green-100 dark:text-black">
        <div className="flex flex-col items-center w-full">
          ...
          <form onSubmit={addReviewsHandler} className="flex flex-col w-full">
            <textarea
              rows="3"
              name="reviewText"
              required
