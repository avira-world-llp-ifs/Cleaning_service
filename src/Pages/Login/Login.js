...
const Login = () => {
 ...
 fetch(`https://cleaner-guy-server.vercel.app/jwt`, {
  ...
  return (
    <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-green-100 lg:max-w-4xl my-20">
      <div
        ...
        <form onSubmit={formHandler}>
          ...
          <div className="mt-4">
            <div className="flex justify-between">
              ...
              <Link to="/forgotPassword" className="text-xs text-black  hover:underline">
                Forget Password?
              </Link>
            </div>
          ...
          <div className="mt-8">
            <button type="submit" className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform bg-green-900 rounded hover:bg-green-400 focus:outline-none ">
              Login
            </button>
          </div>
        </form>
